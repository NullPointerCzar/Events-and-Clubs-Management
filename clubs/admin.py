...
class FacultyAdmin(admin.ModelAdmin):
    ...
    list_display = ('faculty_id', 'department', 'designation')
    list_filter = ('department', 'designation')
    search_fields = ('faculty_id__full_name', 'designation')  # Search by user's name


@admin.register(Club)
class ClubAdmin(admin.ModelAdmin):
    list_display = ('club_id', 'club_name', 'faculty_coordinator_id', 'is_council')
